...
layer_add_child(window_layer, bitmap_layer_get_layer(s_background_layer));
  ...
  text_date_layer = text_layer_create(GRect( -45, 70, bounds.size.w, 34));
  text_layer_set_text_color(text_date_layer, GColorBlack);
  text_layer_set_background_color(text_date_layer, GColorClear);
  text_layer_set_font(text_date_layer, fonts_get_system_font(FONT_KEY_GOTHIC_24_BOLD));
  text_layer_set_text_alignment(text_date_layer, GTextAlignmentCenter);

  text_daynum_layer = text_layer_create(GRect(-70, 70, bounds.size.w, 34));
  ...
  s_wday_layer = text_layer_create(GRect(-40, 50, bounds.size.w, 34));
  ...
  s_connection_layer = text_layer_create(GRect(60, 120, bounds.size.w, 34));
  ...
  s_battery_layer = text_layer_create(GRect( 40, 140, bounds.size.w, 34));
